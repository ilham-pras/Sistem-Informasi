                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <a href="{{ route('tambah-stokproduksi') }}" class="btn btn-primary">
