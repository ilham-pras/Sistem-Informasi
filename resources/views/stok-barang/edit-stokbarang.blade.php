                    ...
                    <div class="row justify-content-center">
                        <div class="col-8">
                            <div class="card">
                                ...
                                <!-- form contents -->
                                <form action="{{ route('update-stokbarang', $stokbarang->id_stok_barang) }}"
                                    method="POST">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <select id="id_barang" name="id_barang" class="form-control" required>
                                                ...
                                                @foreach ($barang as $item)
                                                    <option {{ $item->id_barang == $stokbarang->id_barang ? 'selected' : '' }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="jumlah_stok" name="jumlah_stok" class="form-control"
                                                placeholder="Stok Barang" value="{{ $stokbarang->jumlah_stok }}" required>
                                        </div>
                                    </div>
