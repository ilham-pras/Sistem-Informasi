                        ...
                        <div class="col-8">
                            <div class="card">
                                ...
                                <div class="card-header bg-primary">
                                    <h3 class="card-title">Tambah Tenaga Kerja</h3>
                                </div>

                                <!-- form contents -->
                                <form action="{{ route('simpan-tenaga') }}" method="POST">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="nama_tenaga_kerja" name="nama_tenaga_kerja" class="form-control"
                                                placeholder="Nama Tenaga Kerja" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" id="alamat" name="alamat" class="form-control" placeholder="Alamat Tenaga Kerja" required></textarea>
                                        </div>
                                        <div class="form-group">
